...
payasos=int(112)
munecas=int(75)
compra_payasos=int(input("¿Cuantos payasos quieres comprar? "))
compra_munecas=int(input("¿Cuantas muñecas quieres comprar? "))
paquete=(compra_payasos*payasos)+(compra_munecas*munecas)
print ("El peso del paquete es ", paquete, "gramos")

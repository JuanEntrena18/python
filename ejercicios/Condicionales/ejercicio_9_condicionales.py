...
edad_cliente = int(input("¿Qué edad tienes, chaval? "))
if (edad_cliente <= 4):
    print ("Has tenido suerte, entras gratis")
elif (edad_cliente <=18):
    print ("Lo siento, te toca pagar 5 euros")
elif (edad_cliente >18):
    print ("Como adulto, te toca pagar el máximo, 10 euros")
else:
    print ("Te has equivocado de edad, chaval")
